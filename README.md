## 项目介绍
P-life是用于管理个人消费、锻炼、音乐、阅读、健康、饮食、人生经历等各个衣食住行信息的系统，由统计、计划模块利用调度系统来统计分析执行情况。
...
新版本的P-life项目采用了SpringBoot3，Vue3重构设计。
...
[P-life项目说明](https://gitee.com/mulanbay)
...
### 鸣谢
谢谢JetBrains公司一直以来对P-life项目的支持，提供了全系列产品的免费license。
